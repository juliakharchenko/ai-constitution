...
// import { AIProvider, AIModel, SelectedModels } from '../../types/ai';
...
//     if (modelId === '') {
//       delete newSelectedModels[providerId];
//     } else {
//       newSelectedModels[providerId] = modelId;
//     }
//     onUpdateSelectedModels(newSelectedModels);
//   };
...
//                     name={provider.id}
//                     value=""
//                     checked={!selectedModels[provider.id]}
//                     onChange={(e) => handleModelChange(provider.id, e.target.value)}
//                     className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
//                   />
//                   <label
//                     htmlFor={`${provider.id}-none`}
...
//                       name={provider.id}
//                       value={model.id}
//                       checked={selectedModels[provider.id] === model.id}
//                       onChange={(e) => handleModelChange(provider.id, e.target.value)}
//                       className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
//                     />
//                     <label
...
//                         System prompts: {model.supportsSystemPrompts ? 'Yes' : 'No'}
//                       </div>
//                     </label>
//                   </div>
//                 ))}
...
//             <strong>{selectedCount} model{selectedCount > 1 ? 's' : ''} selected</strong>
