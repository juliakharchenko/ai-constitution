...
// import React from 'react';
// import { Scale } from 'lucide-react';
// import { legalFrameworks } from '@/app/data/legalFrameworks';
// import { researchPapers } from '@/app/data/researchPapers';
...
//   selectedFrameworks,
// }) => {
//   const trustScore = selectedFrameworks.length > 0
//     ? (alignmentScore * weights.alignment + safetyScore * weights.safety) / 100
//     : (alignmentScore * weights.alignment + safetyScore * weights.safety) / 100;
...
//         Trust is calculated as a weighted combination of alignment and safety scores, adjusted by selected legal frameworks. See our <a href="/citations" className="text-indigo-600">Citations</a> for research backing.
//       </p>
//       <p className="text-sm text-gray-600 mb-4">
//         Equation: Trust Score = (Alignment Score × Alignment Weight + Safety Score × Safety Weight) / 100
//       </p>
//       <div className="space-y-4">
//         {/* Framework Weights */}
//         {selectedFrameworks.length > 0 && (
//           <div>
//             <h4 className="text-sm font-medium text-gray-700 mb-2">Legal Framework Weights</h4>
//             {selectedFrameworks.map(frameworkId => {
//               const framework = legalFrameworks.find(f => f.id === frameworkId);
//               return (
//                 <div key={frameworkId} className="flex justify-between mb-2">
...
//                     max="1"
//                     step="0.1"
//                     value={frameworkWeights[frameworkId] || 0}
//                     onChange={(e) => onWeightChange('framework', parseFloat(e.target.value))}
//                     className="w-32"
//                   />
//                   <span>{(frameworkWeights[frameworkId] * 100).toFixed(0)}%</span>
//                 </div>
//               );
//             })}
//           </div>
//         )}
//         {/* Existing Weight Controls */}
//         <div className="grid grid-cols-2 gap-4">
//           <div>
//             <label className="block text-sm font-medium text-gray-700 mb-2">
//               Alignment Weight: {weights.alignment}%
