...
//     setExpandedResponse(expandedResponse === modelId ? null : modelId);
//   };
...
//                     <span>{expandedResponse === response.modelId ? 'Hide' : 'View'}</span>
//                   </button>
//                 )}
//               </div>
//             </div>
...
//                   expandedResponse === response.modelId ? '' : 'line-clamp-3'
//                 }`}>
//                   {response.response}
//                 </div>
                
//                 {expandedResponse === response.modelId && (
...
//                     {alignmentAnalyses && alignmentAnalyses[response.modelId] && (
//                       <AlignmentDisplay analysis={alignmentAnalyses[response.modelId]} />
//                     )}
//                   </div>
//                 )}
//               </>
