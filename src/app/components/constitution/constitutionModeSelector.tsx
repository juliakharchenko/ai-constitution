...
// export function ConstitutionModeSelector({ constitutionMode, setConstitutionMode }: Props) {
//   return (
...
//   constitutionMode: 'template' | 'hofstede' | 'questionnaire';
//   setConstitutionMode: (mode: 'template' | 'hofstede' | 'questionnaire') => void;
// }

// export function ConstitutionModeSelector({ 
//   constitutionMode, 
//   setConstitutionMode 
// }: ConstitutionModeSelectorProps) {
//   return (
//     <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
//       <h2 className="text-xl font-semibold text-gray-800 mb-4">Choose Your Constitution Building Method</h2>
//       <div className="grid md:grid-cols-3 gap-4">
...
import React from 'react';
import { BookOpen, Sliders, HelpCircle, PenTool } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <button
          onClick={() => setConstitutionMode('freewrite')}
          className={`p-4 rounded-lg border-2 transition-all ${
        ...
        >
          <PenTool className="mx-auto mb-2 text-indigo-600" size={24} />
          <h3 className="font-medium">Freewrite</h3>
          <p className="text-sm text-gray-600 mt-1">Write your constitution from scratch</p>
        </button>
      </div>
    </div>
  );
